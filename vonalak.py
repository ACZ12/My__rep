...
def zelst():
    global current_image_index_zelst
    button.destroy()
    button2.destroy()
    button3.destroy()
    button4.destroy()
    ...
    open_image(zelst_image_paths[0])
    current_image_index_zelst = 1
    window.after(1000, lambda: open_next_image(zelst_image_paths, current_image_index_zelst, 1000))

def open_next_image(image_paths, current_index, delay):
    open_image(image_paths[current_index])
    if current_index < len(image_paths) - 1:
        current_index += 1
        window.after(delay, lambda: open_next_image(image_paths, current_index, delay))

current_image_index_zelst = 0
#green
def stavica():
    button.destroy()
    button2.destroy()
    ...
    button10.destroy()
    open_image(image_paths[0])
    window.after(480000, lambda: open_next_image(image_paths[1], 480000))
def open_next_image(image_path, delay):
    open_image(image_path)
    if image_path == image_paths[1]:
        window.after(delay, lambda: open_next_image(image_paths[2], 660000))
image_paths = ["HMD_Center.jpg","HMD_Doh.jpg","HMD_Kolonia.jpg","HMD_Zel._Stanica.jpg",]
current_image_index = 0
#red
def tenkes():
    button.destroy()
...
def open_next_image(image_path, delay):
    ...
    if image_path == image_paths[1]:
        window.after(delay, lambda: open_next_image(image_paths[2], 660000))
image_paths = ["HMD_Center.jpg", "HMD_Doh..jpg", "HMD_Upertown.jpg", "HMD_Ragacou.jpg","HMD_Upertown.jpg","HMD_Selec_Vilage.jpg",]
current_image_index = 0
#yellow
def selecov():
    button.destroy()
...
def open_next_image(image_path, delay):
    ...
    if image_path == image_paths[1]:
        window.after(delay, lambda: open_next_image(image_paths[2], 660000))
image_paths = ["HMD_Center.jpg", "HMD_Doh..jpg","HMD_Upertown.jpg","HMD_Ragacou.jpg",]
current_image_index = 0
#orange
def kolonia():
    button.destroy()
...
def open_next_image(image_path, delay):
    ...
    if image_path == image_paths[1]:
        window.after(delay, lambda: open_next_image(image_paths[2], 660000))
image_paths = ["HMD_Center.jpg", "HMD_Doh..jpg","HMD_Upertown.jpg","HMD_Selec_Vilage.jpg"]
current_image_index = 0
#cyan
def doh():
    button.destroy()
...
def open_next_image(image_path, delay):
    ...
    if image_path == image_paths[1]:
        window.after(delay, lambda: open_next_image(image_paths[2], 660000))
image_paths = ["HMD_Center.jpg", "HMD_Posa.jpg"]
current_image_index = 0
#dark green
def posa():
    button.destroy()
...
def open_next_image(image_path, delay):
    ...
    if image_path == image_paths[1]:
        window.after(delay, lambda: open_next_image(image_paths[2], 660000))
image_paths = ["HMD_Center.jpg", "HMD_futbal.jpg"]
current_image_index = 0
#pink
def sjrd():
    button.destroy()
...
def open_next_image(image_path, delay):
    ...
    if image_path == image_paths[1]:
        window.after(delay, lambda: open_next_image(image_paths[2], 660000))
image_paths = ["HMD_Center.jpg", "HMD_Tenkes1.jpg", "HMD_Stavica.jpg"]
current_image_index = 0
def exit():
    window.destroy()

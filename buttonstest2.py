...
def busses():
    global button, button2, button3, button4, button5, button6, button7, button8, button9
    button = Button(window,text='Bus 1')
    button.config(command=centrum)
    # Configure other properties for the button...
    
    # Repeat the above lines for button2 to button9 with their respective commands and configurations
